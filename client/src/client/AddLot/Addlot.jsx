...
{/* LOT DESCRIPTION */}
                ...
                <div className="row mb-3 rowset">
                  <label for="inputText" className="col-sm-3 col-form-label">LOT DESCRIPTION</label>
                  <div className="col-sm-10">
...
{/* LOT START PRICE */}
                ...
                <div className="row mb-3 rowset">
                  <label for="inputNumber" className="col-sm-3 col-form-label">LOT START PRICE</label>
                  <div className="col-sm-10">
