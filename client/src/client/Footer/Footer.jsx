    ...
    <div className="row">
      ...
      <div className="col-lg-3 col-md-6 footer-contact">
        ...
        <p>
          ...
          Gharuan, Mohali<br/>
          Punjab 140413 <br/><br/>
          <strong>Phone:</strong>+91 8083101612<br/>
          <strong>Email:</strong> abhishek2061a@gmail.com<br/>
        </p>
      </div>
 ...
 */}
          ...
          <a href="#" className="nav-link twitter"><FiTwitter/></a>
          <a href="#" className="nav-link twitter"><AiFillLinkedin/></a>
          <a href="#" className="nav-link twitter"><FiInstagram/></a>
          <a href="#" className="nav-link twitter"><FiMail/></a>
        </div>
      </div>
